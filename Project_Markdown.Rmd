...
plot(L, rat, type="l", log="x", col="darkblue", lwd=1.5,
     xlab = expression(lambda), ylab = "", main = "Shrinkage Profile",las = 1)
...
Final $l_2$ Norm - Taking the square root uses the standard identity $||cv||_{2} = |c| \cdot ||v||_{2}$: $$||\hat{\beta}_{\lambda}^{R}||_{2} = \frac{1}{1+\lambda}||y||_{2} \quad \quad \quad (Formula \quad 2.12) $$
